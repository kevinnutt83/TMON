...
FIRMWARE_VERSION = "v2.04.0"    # Bumped for v2.03.0 OTA and metadata
...
OTA_HTTP_HEADERS = {
    'User-Agent': 'TMON-Device/v2.04.0',
    'Accept': '*/*',
...
FIRMWARE_VERSION = "v2.03.0"    # Bumped for v2.03.0 OTA and metadata
