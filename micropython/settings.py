...
OLED_PAGE_ROTATE_INTERVAL_S = 6
OLED_HEADER_HEIGHT = 14
OLED_FOOTER_HEIGHT = 10
...
STAGED_SETTINGS_KEYS_ALLOW = [
    ...
    'ENABLE_LORA_OTA','LORA_OTA_CHUNK_SIZE','LORA_OTA_MAX_RETRIES',
