...
FIELD_DATA_COMPACT_KEYS = True
FIELD_DATA_SKIP_DEFAULTS = True
FIELD_DATA_ADAPTIVE_BACKPRESSURE = True
FIELD_DATA_MIN_BATCH = 5
FIELD_DATA_MEM_LOW_WATERMARK = 40 * 1024
...
PROVISION_CHECK_INTERVAL_S = 120
...
LORA_BASE_BEACON_ENABLED = True
LORA_BASE_BEACON_INTERVAL_S = 30
LORA_BASE_BEACON_PAUSE_DURING_SESSION = True
CLK_PIN = 35
MOSI_PIN = 36
MISO_PIN = 37
CS_PIN = 14
...
REMOTE_ACK_WAIT_S = 30
REMOTE_REPAIR_ACK_WAIT_S = 30
REMOTE_FAILED_SYNC_RETRY_S = 60
LORA_SESSION_ENABLED = True
LORA_SIMPLE_SESSION_ONLY = True
LORA_HELLO_TIMEOUT_S = 15
LORA_HELLO_RETRIES = 6
LORA_SESSION_SILENCE_S = 20
LORA_SESSION_SILENCE_ACK_S = 5
LORA_TX_DONE_WAIT_S = 1.5
LORA_TX_EXCEPTION_RESET_COUNT = 3
LORA_LOOP_INTERVAL_S = 0.08
PAIRED_BASE_UID = ''
...
REMOTE_BATTERY_CRITICAL_V = 3.30
REMOTE_SLEEP_MULTIPLIER_LOW = 1.5
REMOTE_SLEEP_MULTIPLIER_CRITICAL = 3.0
REMOTE_EXT_WAKE_PIN = None
REMOTE_EXT_WAKE_LEVEL = 0
REMOTE_EXT_WAKE_RECOVERY_DISABLE_SLEEP = False
LORA_SESSION_BUSY_TIMEOUT_S = 25
LORA_SLOT_SPACING_S = 20
LORA_CHECK_IN_MINUTES = 5
LORA_WATCHDOG_HARD_RESET_ON_IDLE = False
LORA_WATCHDOG_TIMEOUT_S = 86400
LORA_REMOTE_WATCHDOG_S = 600
LORA_INIT_RETRY_BACKOFF_S = 1
LORA_MAX_RETRIES = 4
LORA_HELLO_RETRIES = 6
LORA_HELLO_TIMEOUT_S = 45
LORA_HELLO_RETRY_GAP_S = 6
LORA_TX_DONE_WAIT_S = 2.0
...
LORA_HMAC_ENABLED = False
LORA_HMAC_SECRET = '7383daf15e2f078f7d4316f4aa0d0e9746355b461da5932e4d62352b4e728197'
LORA_HMAC_TRUNCATE = 8
LORA_HMAC_REJECT_UNSIGNED = False
LORA_HMAC_REPLAY_PROTECT = False
LORA_REPLAY_WINDOW = 8
LORA_COUNTERS_FILE = '/logs/lora_counters.json'
LORA_SESSION_SOFT_CRC = True
REMOTE_BASE_STARTUP_WAIT_S = 45
...
LORA_RELAY_MAX_TTL = 2
LORA_RELAY_DUPE_CACHE = 32
LORA_RELAY_MIN_RSSI = -120
LORA_RELAY_FORWARD_DELAY_MS = 80
LORA_RELAY_ONLY_WHEN_HUB_SILENT = True
LORA_HUB_HEARD_S = 45
LORA_DIRECT_THEN_RELAY = False
LORA_ENCRYPT_ENABLED = False
LORA_ENCRYPT_SECRET = ''
FREQ = 915.0
BW = 125.0
SF = 10
...
USE_LDO = True
CAD_SYMBOLS = 8
LORA_ENABLE_CAD = True
LORA_CAD_BACKOFF_S = 2
LORA_CAD_BACKOFF_MAX_S = 30
LORA_CAD_FORCE_TX = False
ENABLE_LORA_OTA = False
LORA_OTA_CHUNK_SIZE = 120
LORA_OTA_MAX_RETRIES = 3
REMOTE_OTA_WAIT_S = 90
LORA_OTA_STAGE_MANIFEST_FILE = LOG_DIR + '/lora_ota_staged_manifest.json'
...
OLED_PAGE_ROTATE_INTERVAL_S = 8
OLED_HEADER_HEIGHT = 16
OLED_FOOTER_HEIGHT = 8
...
OTA_FILES_ALLOWLIST = [
    'main.py','remote_node.py','lora.py','utils.py','sampling.py','settings.py','relay.py','oled.py','ota.py','wprest.py'
]
...
DIAGNOSTIC_RETRY_BASE_S = 600
DIAGNOSTIC_FAILURE_STREAK = 3
DIAGNOSTIC_FAILURE_COOLDOWN_S = 600
ENABLE_DIAGNOSTICS_UPLOAD = False

DEVICE_SUSPENDED = False
DEVICE_SUSPENDED_FILE = LOG_DIR + '/suspended.flag'
...
BASE_REMOTE_TABLE_FILE = LOG_DIR + '/remotes.table.json'
...
COMMAND_CONFIRM_HMAC_SECRET = ''
COMMAND_CONFIRM_HMAC_TRUNCATE = 32
...
STAGED_SETTINGS_KEYS_ALLOW = [
    ...
    'COMMAND_CONFIRM_HMAC_SECRET','COMMAND_CONFIRM_HMAC_TRUNCATE',
    'FIELD_DATA_COMPACT_KEYS','FIELD_DATA_SKIP_DEFAULTS',
    'FIELD_DATA_ADAPTIVE_BACKPRESSURE','FIELD_DATA_MIN_BATCH','FIELD_DATA_MEM_LOW_WATERMARK',
    'COMMANDS_POLL_INTERVAL_S','COMMANDS_POLL_JITTER_S','COMMANDS_MAX_PER_POLL',
    'COMMAND_CONFIRM_DELAY_S','COMMANDS_RESULT_TIMEOUT_S',
    'ENABLE_LORA_OTA','LORA_OTA_CHUNK_SIZE','LORA_OTA_MAX_RETRIES','REMOTE_OTA_WAIT_S',
    'LORA_CHUNK_SIZE','LORA_MAX_PACKET_SIZE','LORA_HUB_IDLE_RELEASE_S','LORA_HUB_SESSION_TIMEOUT_S',
    'LORA_REPAIR_WINDOW_S','LORA_ACK_MIN_INTERVAL_S','LORA_MAX_MISS_ROUNDS','LORA_PREFER_TWO_CHUNKS','LORA_SINGLE_CHUNK_MAX_B64','LORA_INTER_CHUNK_MS','REMOTE_ACK_WAIT_S',
    'REMOTE_REPAIR_ACK_WAIT_S','LORA_HELLO_RETRY_GAP_S','LORA_ENABLE_CAD','LORA_HMAC_ENABLED','CRC_ON',
    'COMMAND_ACK_UNSUPPORTED',
    'ENABLE_DIAGNOSTICS_UPLOAD',
    'DEBUG','DEBUG_PROVISION','DEBUG_LORA','DEBUG_WIFI','DEBUG_OTA',
    'DEBUG_FIELD_DATA','DEBUG_WPREST','DEBUG_BASE_NODE','DEBUG_REMOTE_NODE','DEBUG_USER_CMD','DEBUG_ROUTINES',
...
LORA_CHUNK_SIZE = 24
LORA_PREFER_TWO_CHUNKS = False
LORA_SINGLE_CHUNK_MAX_B64 = 140
LORA_INTER_CHUNK_MS = 1800
LORA_HUB_IDLE_RELEASE_S = 18
LORA_HUB_SESSION_TIMEOUT_S = 35
LORA_REPAIR_WINDOW_S = 70
LORA_ACK_MIN_INTERVAL_S = 8
LORA_MAX_MISS_ROUNDS = 1
LORA_BURST_GUARD_S = 40
