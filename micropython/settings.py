...
LORA_HUB_IDLE_RELEASE_S = 25
LORA_HUB_SESSION_TIMEOUT_S = 45
LORA_REPAIR_WINDOW_S = 30
LORA_ACK_MIN_INTERVAL_S = 8
LORA_MAX_MISS_ROUNDS = 2
...
STAGED_SETTINGS_KEYS_ALLOW = [
    ...
    'LORA_CHUNK_SIZE','LORA_MAX_PACKET_SIZE','LORA_HUB_IDLE_RELEASE_S',
    'LORA_HUB_SESSION_TIMEOUT_S','LORA_REPAIR_WINDOW_S','LORA_ACK_MIN_INTERVAL_S',
    'LORA_MAX_MISS_ROUNDS','LORA_BASE_BEACON_PAUSE_DURING_SESSION',
    'REMOTE_ACK_WAIT_S','REMOTE_REPAIR_ACK_WAIT_S','LORA_HELLO_RETRY_GAP_S',
