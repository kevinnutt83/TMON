...
EOT;
    ...
    foreach ($rows as $r) {
        ...
        echo ' Role <select name="role"><option value="base" '.(($r['role'] === 'base') ? ' selected' : '').'>base</option><option value="remote" '.(($r['role'] === 'remote') ? ' selected' : '').'>remote</option></select>';
...
add_action('admin_enqueue_scripts', function() {
	// use plugins_url() to compute plugin assets URL (avoids "includes" segment)
	$assets_url = plugins_url( 'assets', __FILE__ ); // resolves to .../wp-content/plugins/tmon-admin/assets
