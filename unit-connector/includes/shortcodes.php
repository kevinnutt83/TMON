...
if (!function_exists('tmon_uc_normalize_telemetry_point')) {
    function tmon_uc_normalize_telemetry_point(array $d, $ts = null) {
        ...
        $point = [
            ...
            'probe_temp_f'  => $get(['probe_temp_f', 'temp_f', 'cur_temp_f', 'temperature_f', 't_f']),
            'probe_temp_c'  => $get(['probe_temp_c', 'temp_c', 'cur_temp_c', 'temperature_c', 't_c']),
            ...
            'probe_humid'   => $get(['probe_humid', 'humid', 'cur_humid', 'humidity', 'h', 'hum']),
            'device_humid'  => $get(['device_humid', 'cur_device_humid', 'dh']),
            'bar'           => $get(['bar', 'cur_bar_pres', 'pressure', 'bar_pres', 'probe_bar', 'bar_pres']),
            'probe_bar'     => $get(['probe_bar', 'bar', 'cur_bar_pres', 'pressure', 'bar_pres']),
    ...
    (function(){
        ...
        function buildDynamicDatasets(points) {
            ...
            const preferred = {
                ...
                probe_temp_f: { label: 'Probe Temp (F)', yAxisID: 'y1' },
                probe_temp_c: { label: 'Probe Temp (C)', yAxisID: 'y1' },
                ...
                probe_humid: { label: 'Probe Humidity (%)', yAxisID: 'y2' },
                ...
                probe_bar: { label: 'Probe Pressure (hPa)', yAxisID: 'y3' },
